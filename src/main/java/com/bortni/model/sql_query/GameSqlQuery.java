...
public class GameSqlQuery {
    ...
    public static final String CREATE = "INSERT INTO " +
            "games(game_identification, round_time, players_number, rounds_number) " +
            "VALUES (?, ?, ?, ?) ";

    public static final String UPDATE = "UPDATE questions " +
            "SET expert_score = ?, opponent_score = ?, number_of_used_hints = ?, " +
            "average_time_per_round = ?, average_score_per_round = ? " +
            "WHERE games.game_id = ? ";

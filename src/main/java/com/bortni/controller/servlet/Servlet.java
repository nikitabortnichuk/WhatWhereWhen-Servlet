...
import com.bortni.controller.command.admin.AdminCommand;
import com.bortni.controller.command.ProfileCommand;
import com.bortni.controller.command.admin.SignInAdminCommand;
import com.bortni.controller.command.authorization.LogoutCommand;
...
public class Servlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        commands.put(UrlPath.ADMIN, new AdminCommand());
        ...
        commands.put(UrlPath.LOGOUT, new LogoutCommand());
